...
export default function CreateProject() {
  ...
  const createProject = () => {
    if (!project.title || !project.description || !project.company) {
      toast({
        title: "Error",
        ...
        <Card>
          ...
          <CardContent className="space-y-6">
            ...
            <div>
              ...
              <div className="grid grid-cols-3 gap-4 mt-2">
                <div>
                  ...
                  <Input
                    type="number"
                    value={project.salary_range.min}
                    onChange={(e) => setProject({
                      ...project,
                      salary_range: { ...project.salary_range, min: parseInt(e.target.value) || 0 }
                    })}
                    placeholder="300000"
                  />
                </div>
                <div>
                  ...
                  <Input
                    type="number"
                    value={project.salary_range.max}
                    onChange={(e) => setProject({
                      ...project,
                      salary_range: { ...project.salary_range, max: parseInt(e.target.value) || 0 }
                    })}
                    placeholder="500000"
                  />
                </div>
                <div>
                  ...
                  <Select 
                    value={project.salary_range.currency}
                    onValueChange={(value) => setProject({
                      ...project,
                      salary_range: { ...project.salary_range, currency: value }
                    })}
                  >
                    <SelectTrigger>
                      <SelectValue />
            ...
            <div className="flex justify-end gap-3 pt-4 border-t">
              ...
              <Button onClick={createProject}>Create Job Posting</Button>
            </div>
          </CardContent>
        </Card>
      </div>
